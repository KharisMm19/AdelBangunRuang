...
public class SoundManager : MonoBehaviour
{
    ...
    public void StopSound(AudioClip clip, float volume)
    {
        StartCoroutine(StopSoundCoroutine(clip, volume));
    }
    ...
    public IEnumerator StopSoundCoroutine(AudioClip clip, float volume)
    {
